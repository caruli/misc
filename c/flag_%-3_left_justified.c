...
int main() {
 ...
 addition = sum(mbank,tipsport,bank_notes,coins,care_benefit,debt);  
  ...
  printf("       Mbank: %s%11.2f %s\n",TC_GRN, mbank,TC_NRM);
  printf("    Tipsport: %s%11.2f %s\n",TC_GRN, tipsport,TC_NRM);
  printf("  Bank notes: %s%11.2f %s\n",TC_GRN, bank_notes,TC_NRM);
  printf("       Coins: %s%11.2f  %s\n",TC_GRN, coins,TC_NRM);
  printf("Care benefit: %s%11.2f %s\n",TC_GRN, care_benefit,TC_NRM);
  printf("        Debt: %s%11.2f %s\n",TC_RED, debt,TC_NRM);
  puts("");
  printf("         Sum: %s%11.2f %s\n",TC_GRN,addition,TC_NRM);
  puts("");
